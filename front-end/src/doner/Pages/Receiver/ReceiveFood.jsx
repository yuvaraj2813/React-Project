...
const ReceiveFood = () => {
  ...
  return (
    <div className="flex h-screen mt-10">
      {/* Navigation Rail */}
      <div className="lg:w-[200px] bg-gray-100 border-r border-gray-300 shadow-md flex flex-col py-4 lg:h-full lg:sticky lg:top-0 lg:flex-none">
        <a
          href="#"
          className="px-4 py-2 text-gray-700 hover:bg-blue-100 hover:text-blue-600 rounded-md"
          onClick={() => setCurrentPage("accountDetails")} // Set currentPage to accountDetails
      ...
      {/* Main Content */}
      <div className="flex-1 p-6 overflow-auto lg:ml-[200px]">
        {/* Content Scrollable */}
